                ...
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link href="/customer" className="hover:text-pink-400 transition-colors">
                                    Login
                                </Link>
                            </li>
                            <li>
                                <Link href="/seller" className="hover:text-pink-400 transition-colors">
                                    Register
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link href="/help-center" className="hover:text-pink-400 transition-colors">
                                    Help Center
                                </Link>
                            </li>
                            <li>
                                <Link href="/safety-guidelines" className="hover:text-pink-400 transition-colors">
                                    Safety Guidelines
                                </Link>
                            </li>
                            <li>
